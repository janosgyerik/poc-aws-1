...
public class SendMessage {
  ...
  public static void main(String[] args) throws IOException {
    ...
    SENDER = args[0];
    RECIPIENT = args[1];
    SENDER = "claire.villard@sonarsource.com";
    RECIPIENT = "claire.villard@sonarsource.com";
    SUBJECT = args[2];
  ...
  public static void send() throws AddressException, MessagingException, IOException {
    ...
    try {
      ...
      System.out.println(sendRawEmailResponse);
      System.out.println(sendRawEmailResponse.messageId());
      System.out.println(sendRawEmailResponse.sdkFields());
